...
steps:
  ...
  primary-malignancy_oesophageal-history---primary:
    run: primary-malignancy_oesophageal-history---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  oesophageal---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: primary-malignancy_oesophageal-history---primary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: oesophageal---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
